const { AdministradorModel } = require("../models/index.model");
...
const getAdministradores = async (req, res) => {
    try {
        ...
        const administradores = await AdministradorModel.findAndCountAll({
            where: { activa },
...
const getAdministrador = async (req, res) => {
    try {
        ...
        const administrador = await AdministradorModel.findByPk(id);
...
const createAdministrador = async (req, res) => {
    try {
        ...
        const nuevoAdministrador = await AdministradorModel.create({
            usuario,
            contrasena,
            email,
        });
