// controllers/carritosProductos.controller.js
const { CarritoProductoModel } = require("../models/index.model");
...
const getCarritosProductos = async (req, res) => {
  try {
    ...
    const registros = await CarritoProductoModel.findAndCountAll({
...
const getCarritoProducto = async (req, res) => {
  try {
    ...
    const registro = await CarritoProductoModel.findByPk(id);
...
const createCarritoProducto = async (req, res) => {
  try {
    ...
    const nuevoRegistro = await CarritoProductoModel.create({
      cantidad,
      idProducto,
      idCarrito,
    });
