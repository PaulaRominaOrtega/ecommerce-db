const { CategoriaModel, ProductoModel } = require("../models/index.model");
...
const getCategorias = async (req, res) => {
    try {
        ...
        const { page = 1, limit = 10, activo, search, sort = 'createdAt', direction = 'DESC' } = req.query;
        ...
        const categorias = await CategoriaModel.findAndCountAll({
            where: whereClause,
